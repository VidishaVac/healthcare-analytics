...
Before we explore how downstream outcomes — like early hospital readmissions — may be influenced by specific care delivery actions, such as whether a patient’s HbA1c was measured during their stay, let’s ground ourselves in the dataset. We’ll start by summarizing key variables, which include:
...
# Reshaping to get a better view of medications
meds <- D %>%
